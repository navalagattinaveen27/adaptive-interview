          ...
          <Tabs defaultValue="login">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div><Label htmlFor="login-pass">Password</Label><Input id="login-pass" name="password" type="password" required /></div>
                <Button className="w-full gradient-primary text-primary-foreground" disabled={loading}>Login</Button>
              </form>
            </TabsContent>

            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                <div><Label htmlFor="signup-name">Full Name</Label><Input id="signup-name" name="name" required /></div>
                <div><Label htmlFor="signup-email">Email</Label><Input id="signup-email" name="email" type="email" required /></div>
                <div><Label htmlFor="signup-pass">Password</Label><Input id="signup-pass" name="password" type="password" required minLength={6} /></div>
                <Button className="w-full gradient-primary text-primary-foreground" disabled={loading}>Create Account</Button>
              </form>
            </TabsContent>
          </Tabs>
        </CardContent>
